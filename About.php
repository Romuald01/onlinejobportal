	...
	<section class="section-padding">
		<div class="container">
			<div class="row showcase-section">
				<div class="col-md-6">
					<img src="dist/img/onlinejobimg.png" class="img-reponsive about-big-img" alt="showcase image">
				</div>
				<div class="col-md-6">
						...
						<div class="team-six">
							<div class="row">
								<div class="col-md-3 col-sm-6">
									<!-- Team Member -->
									<div class="team-member text-align-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/avatar.png" alt="john picture">
										<!-- Name -->
										<h4>Johne Doe</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-align-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/avatar5.png" alt="Romuald picture">
										<!-- Name -->
										<h4>Romuald</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-align-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/bill gate.jfif" alt="bill gate picture">
										<!-- Name -->
										<h4>Bill Gate</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member text-align-center">
										<!-- Image -->
										<img class="img-responsive" src="dist/img/steve.jfif" alt="steve jobs picture">
										<!-- Name -->
										<h4>Steve Jobs</h4>
