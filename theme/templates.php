        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Online Jobs<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Iyana Iyesi Ota<br>
           Ogun State.</address>
          <p>
            <i class="icon-phone"></i>09063514430<br>
            <i class="icon-envelope-alt"></i> romualdadjimagbe2018@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Job Portal 2021 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
